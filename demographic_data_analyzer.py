...
def calculate_demographic_data(print_data=True):
    ...
    country_df = (df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts() * 100).sort_values(ascending=False)
    highest_earning_country = country_df.index[0]
    highest_earning_country_percentage = round(country_df.iloc[0], 1)
